...
export default function AdminPage() {
  ...
  async function saveHours(day: number, active: boolean) {
    ...
    const payload = { day_of_week: day, start_time: existing?.start_time?.slice(0, 5) ?? "09:00", end_time: existing?.end_time?.slice(0, 5) ?? "20:00", active };
